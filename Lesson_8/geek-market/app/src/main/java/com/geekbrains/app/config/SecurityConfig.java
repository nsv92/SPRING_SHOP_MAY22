...
// отключение авторизации для теста fileStore
        http.csrf().disable();


//        http.authorizeRequests()
//                .antMatchers(HttpMethod.OPTIONS,"/storefile").permitAll()
//                .antMatchers(HttpMethod.OPTIONS,"/storefile/**").permitAll()
//                .antMatchers(HttpMethod.OPTIONS,"/getfile/**").permitAll()
//                .antMatchers(HttpMethod.OPTIONS,"/getfiles/**").permitAll()
//
